...
export const ADD_MEMBER_REQUEST = 'REGISTER_GROUP_REQUEST';
export const ADD_MEMBER_SUCCESS = 'REGISTER_GROUP_SUCCESS';
export const ADD_MEMBER_FAILURE = 'REGISTER_GROUP_FAILURE';
